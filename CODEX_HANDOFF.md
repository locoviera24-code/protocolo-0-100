...
Service worker cache: `protocolo-0-100-pwa-v40`
...
- PWA offline con cache v40 y actualizacion consentida desde el aviso visible.
...
- `sw.js`: cache v40, actualizacion consentida, incluye modulos nuevos y evita
...
- Version objetivo: `2.6.1`, Android `versionCode 32`, cache PWA `v40`.
