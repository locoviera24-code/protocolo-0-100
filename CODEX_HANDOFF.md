...
Service worker cache: `protocolo-0-100-pwa-v37`
...
- PWA offline con cache v37 y actualizacion consentida desde el aviso visible.
...
- `sw.js`: cache v37, actualizacion consentida, incluye modulos nuevos y evita
...
- Version objetivo: `2.6.1`, Android `versionCode 32`, cache PWA `v37`.
