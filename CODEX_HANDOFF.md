...
Service worker cache: `protocolo-0-100-pwa-v41`
...
- PWA offline con cache v41 y actualizacion consentida desde el aviso visible.
...
- `sw.js`: cache v41, actualizacion consentida, incluye modulos nuevos y evita
...
- Version objetivo: `2.6.1`, Android `versionCode 32`, cache PWA `v41`.
