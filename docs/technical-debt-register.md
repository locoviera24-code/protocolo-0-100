...
| DOC-001 | P2 | Handoff/version visible | `CODEX_HANDOFF.md` aun declara una rama Phase 0 como esperada y `README.md` menciona el candidato Home `97/41` aunque `app-version.json` ya identifica el siguiente candidato. | Contexto operativo falso para la siguiente persona/agente. | Actualizar handoff/README en un PR documental acotado; mantener historia separada del estado actual. | OPEN |
