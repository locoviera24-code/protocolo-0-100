(function(global){
  ...
  const ENTRIES=Object.freeze([
    entry('dailyLogs','protocolo_0_100_tracker_v1','protocol',{defaultValue:[],validator:validators.array,backupField:'entries',backupAliases:['dailyLogs']}),
    entry('legacyGymSessions','protocolo_0_100_gym_sessions_v1','protocol',{defaultValue:[],validator:validators.array,backupField:'gymSessions',storageMode:'legacy',mirrorEnabled:true,resetGroup:'workout',retention:'migration-only'}),
    entry('startDate','protocolo_0_100_start_date_v1','protocol',{defaultValue:null,validator:validators.nullableString,backupField:'startDate',storageMode:'local',mirrorEnabled:false,serialization:'raw'}),
    ...
    entry('sessions','protocolo_0_100_workout_sessions_v1','workout',{defaultValue:[],validator:validators.array,backupField:'workoutSessions',legacyKeys:['protocolo_0_100_gym_sessions_v1']}),
    ...
    entry('exerciseLibrary','protocolo_0_100_exercise_library_v1','workout',{defaultValue:[],validator:validators.array,backupField:'exerciseLibrary'}),
    ...
    entry('equipmentProfiles','protocolo_0_100_equipment_profiles_v1','workout',{defaultValue:[],validator:validators.array,backupField:'equipmentProfiles'}),
    entry('exercisePreferences','protocolo_0_100_exercise_preferences_v1','workout',{defaultValue:{schemaVersion:1,exercises:{}},validator:validators.object,backupField:'exercisePreferences'}),
    ...
    entry('entries','protocolo_0_100_nutrition_entries_v1','nutrition',{defaultValue:[],validator:validators.array,backupField:'nutritionEntries',backupAliases:['meals']}),
    ...
    entry('customFoods','protocolo_0_100_custom_foods_v1','nutrition',{defaultValue:[],validator:validators.array,backupField:'customFoods'}),
    ...
    entry('savedMeals','protocolo_0_100_saved_meals_v1','nutrition',{defaultValue:[],validator:validators.array,backupField:'savedMeals'}),
    entry('recipes','protocolo_0_100_recipes_v1','nutrition',{defaultValue:[],validator:validators.array,backupField:'recipes'}),
    ...
    entry('sharedSessions','protocolo_0_100_shared_workout_sessions_v1','gymParty',{defaultValue:[],validator:validators.array,backupField:'sharedWorkoutSessions'}),
    entry('sharedSets','protocolo_0_100_shared_workout_sets_v1','gymParty',{defaultValue:[],validator:validators.array,backupField:'sharedWorkoutSets'}),
    entry('syncQueue','protocolo_0_100_gym_party_sync_queue_v1','gymParty',{defaultValue:[],validator:validators.array,backupField:'syncQueue'}),
    ...
    entry('drafts','protocolo_0_100_drafts_v1','drafts',{defaultValue:{version:1,updatedAt:'',items:{}},validator:validators.object,backup:false,storageMode:'local',mirrorEnabled:false,retention:'ttl:14d'}),
    ...
    entry('versionedState','protocolo_0_100_state_v2','backup',{schemaVersion:2,defaultValue:{},validator:validators.object,backup:false}),
    ...
    entry('dataLayerConfig','protocolo_0_100_data_layer_v1','diagnostics',{defaultValue:{},validator:validators.object,backup:false,storageMode:'local',mirrorEnabled:false}),
  ...
  function validate(key,value){
    ...
    try{return record.validator(value)?{status:'valid',key,record,value}:{status:'corrupt',key,record,error:'schema-validation'};}
