...
const CORE_ASSETS = ['./', './index.html', './nutrition-data.js', './fdc-client.js', './workout-ranking.js', './workout-features.js', './gym-party.js', './advanced-features.js', './manifest.webmanifest', './icons/icon-192.png', './icons/icon-512.png'];
