...
const CORE_ASSETS = ['./', './index.html', './app-version.js', './styles/tokens.css', './styles/base.css', './styles/components.css', './styles/features.css', './styles/gym.css', './styles/gym-party.css', './styles/modules.css', './styles/responsive.css', './ui/router.js', './ui/navigation.js', './progress/progress-view.js', './nutrition-data.js', './fdc-client.js', './workout-store.js', './workout-plan.js', './workout-metrics.js', './workout-ranking.js', './workout-ui.js', './workout-features.js', './firebase-service.js', './gym-party-sync.js', './gym-party-metrics.js', './gym-party-ui.js', './gym-party.js', './advanced-features.js', './manifest.webmanifest', './icons/icon-192.png', './icons/icon-512.png'];
