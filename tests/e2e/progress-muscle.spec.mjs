...
async function seed(page){
  ...
  await page.evaluate(async()=>{
    ...
    const sessions=[{id:'progress-now',date:date(-1),status:'finalizado',routine:{name:'Prueba'},exercises:[
    ...
    ]},{id:'progress-prev',date:date(-8),status:'finalizado',routine:{name:'Previa'},exercises:[{id:'press-banca-pecho',exerciseId:'press-banca',name:'Press de banca',muscle:'Pecho',sets:[{id:'old1',reps:8,weight:55},{id:'old2',reps:8,weight:55}]}]}];
