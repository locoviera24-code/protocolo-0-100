...
$requiredFiles = @(
    ...
    'scripts/serve-static.mjs', 'scripts/build-web-dist.mjs', 'scripts/test-web-dist.mjs', 'playwright.config.mjs', 'playwright.web-dist.config.mjs', 'tests/web-dist/web-dist.spec.mjs', 'tests/e2e/gym-flow.spec.mjs', 'tests/e2e/gym-canonical.spec.mjs', 'tests/e2e/gym-set-types.spec.mjs', 'tests/e2e/gym-first-home.spec.mjs', 'tests/e2e/visual-navigation.spec.mjs', 'tests/e2e/router.spec.mjs', 'tests/e2e/layout-sticky.spec.mjs', 'tests/e2e/home-settings.spec.mjs', 'tests/e2e/notifications-recovery.spec.mjs', 'tests/e2e/progress.spec.mjs', 'tests/e2e/progress-muscle.spec.mjs', 'tests/e2e/progress-exercise.spec.mjs', 'tests/e2e/data-layer.spec.mjs', 'scripts/test-muscle-progress.mjs', 'scripts/test-exercise-progress.mjs',
...
foreach ($script in @('app/gym-home-state.js', 'app/gym-home-controller.js')) {
    Assert-True ($html.Contains('<script src="' + $script + '"></script>')) "index.html no carga $script"
    Assert-True ($precacheManifest.Contains('"url": "./' + $script + '"')) "precache-manifest.js no cachea $script"
}
