...
const equipmentSessions=[
  ...
  {id:'smith',date:'2026-07-11',exercises:[ex('press','Press banca',[{reps:8,weight:40,loadMode:'perSide',barWeightKg:0,equipmentId:'smith'}])]},
  {id:'smith-2',date:'2026-07-12',exercises:[ex('press','Press banca',[{reps:9,weight:40,loadMode:'perSide',barWeightKg:0,equipmentId:'smith'}])]}
];
